async function getData() {
    ...
    document.getElementById("total-cases").innerHTML = turnAngka(
        TotalConfirmed
    );
}
    ...
    myChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
            ...
            pointHoverRadius: 0,
            borderWidth: 3,
            data: [300, 310, 316, 322, 330, 326, 333, 345, 338, 354, 362, 452]
          },
          {
            borderColor: "#fcc468",
            ...
            pointHoverRadius: 0,
            borderWidth: 3,
            data: [320, 340, 365, 360, 370, 385, 390, 384, 408, 420, 442, 452]
          },
          {
            borderColor: "#f17e5d",
            ...
            pointHoverRadius: 0,
            borderWidth: 3,
            data: [370, 394, 415, 409, 425, 445, 460, 450, 478, 484, 492, 502]
          }
        ]
      },
      options: {
